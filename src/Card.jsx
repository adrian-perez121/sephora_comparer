function Card({product_data, ...props}) {
    ...
    const ratingsColor = props["ratingsColor"] ? props["ratingsColor"] : "black";
    const reviewsColor = props["reviewsColor"] ? props["reviewsColor"] : "black";
    const priceColor = props["priceColor"] ? props["priceColor"] : "black";

    return (
        <div className="flex flex-col border-2 items-start border-l-black relative" onClick={onClickWrapper ? onClickWrapper : null}>
